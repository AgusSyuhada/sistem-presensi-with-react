...
import { useEditGuruController } from "../../hooks/useEditTeacherController";
                ...
                <main className="flex-1 overflow-y-auto bg-[#f5f5f5] dark:bg-[#374151] p-4 md:p-6">
                    ...
                    {isLoading && (
                        <div className="text-center p-6">
                            <span className="text-gray-500 dark:text-gray-400">Loading data guru...</span>
                        </div>
                    )}

                    {/* Tampilkan form hanya jika tidak loading */}
                    {!isLoading && !error && (
                        <div className="bg-white dark:bg-[#1F2937] p-4 md:p-6 rounded-lg shadow-md">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mt-6">
                                    <button
                                        type="submit"
                                        className={`w-full bg-[#4caf50] text-white font-bold py-2.5 px-4 rounded-lg hover:bg-green-600 transition-colors ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
