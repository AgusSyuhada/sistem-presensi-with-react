...
CREATE TABLE Tenaga_Kependidikan (
    id_tendik VARCHAR(20) PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_embedding_vector ON Tenaga_Kependidikan USING ivfflat (embedding_vector vector_cosine_ops) WITH (lists = 100);
...
('20157483926104', 'Ahmad Hidayat', 'ahmad.hidayat@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 1, 'III/a', '2020-01-15', 'Drs.', 'M.Pd', 'Jakarta', '1985-03-12', 'Islam', 'Laki-laki', 'S2', 'PNS', '081234567890', 'https://i.pravatar.cc/150?img=12', NULL),
('19384729561038', 'Siti Nurhaliza', 'siti.nurhaliza@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 2, 'III/b', '2019-06-20', NULL, 'S.Kom', 'Bandung', '1990-07-22', 'Islam', 'Perempuan', 'S1', 'PNS', '081234567891', 'https://i.pravatar.cc/150?img=5', NULL),
('21469273851047', 'Budi Santoso', 'budi.santoso@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 1, 'II/d', '2021-03-10', NULL, 'S.T', 'Surabaya', '1992-11-05', 'Islam', 'Laki-laki', 'S1', 'PPPK', '081234567892', 'https://i.pravatar.cc/150?img=13', NULL),
('18275639841029', 'Dewi Lestari', 'dewi.lestari@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 2, 'III/c', '2018-09-01', 'Dr.', 'M.Si', 'Yogyakarta', '1987-04-18', 'Islam', 'Perempuan', 'S2', 'PNS', '081234567893', 'https://i.pravatar.cc/150?img=9', NULL),
('22836174592063', 'Eko Prasetyo', 'eko.prasetyo@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 1, 'II/c', '2022-01-05', NULL, 'S.E', 'Semarang', '1993-08-30', 'Kristen', 'Laki-laki', 'S1', 'Kontrak', '081234567894', 'https://i.pravatar.cc/150?img=14', NULL),
('20594837261058', 'Fitriani Wulandari', 'fitriani.w@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 2, 'III/a', '2020-07-12', NULL, 'S.Pd', 'Medan', '1991-02-14', 'Islam', 'Perempuan', 'S1', 'PNS', '081234567895', 'https://i.pravatar.cc/150?img=10', NULL),
('21748296351072', 'Gunawan Wijaya', 'gunawan.w@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 1, 'II/d', '2021-11-20', NULL, 'A.Md', 'Makassar', '1994-09-25', 'Katolik', 'Laki-laki', 'D3', 'PPPK', '081234567896', 'https://i.pravatar.cc/150?img=15', NULL),
('19562847391086', 'Hana Pertiwi', 'hana.pertiwi@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 2, 'III/b', '2019-04-08', NULL, 'S.Sos', 'Palembang', '1989-12-10', 'Islam', 'Perempuan', 'S1', 'PNS', '081234567897', 'https://i.pravatar.cc/150?img=1', NULL),
('22937164825093', 'Irfan Maulana', 'irfan.maulana@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 1, 'II/c', '2022-05-15', NULL, 'S.Kom', 'Pekanbaru', '1995-06-18', 'Islam', 'Laki-laki', 'S1', 'Kontrak', '081234567898', 'https://i.pravatar.cc/150?img=33', NULL),
('20681539274102', 'Julia Rahmawati', 'julia.r@example.com', '$2a$12$1kJWQAREUQ5t8WKzF7Ebgu/YfEVJcO4mXodI5CwZAzBNHmLhD453q', 2, 'III/a', '2020-10-22', NULL, 'S.Psi', 'Denpasar', '1990-03-27', 'Hindu', 'Perempuan', 'S1', 'PNS', '081234567899', 'https://i.pravatar.cc/150?img=20', NULL),
