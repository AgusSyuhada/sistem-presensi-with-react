// Modifikasi file: front-end/src/pages/AttendanceHistory.js
// (Sesuaikan tabel dengan field backend: id_presensi, waktu, status, nama, dll.)
// Ganti kolom sesuai response backend, misalnya tanggal dari waktu, waktu dari waktu, status, dll.
              ...
              <table className="w-full min-w-[800px] text-left text-sm border-collapse border border-[#E4E4E7] dark:border-[#374151]">
                <thead className="bg-gray-100 dark:bg-[#374151]">
                  <tr>
                    ...
                    <th className="p-4 font-medium text-[#18181B] dark:text-[#F9FAFB] border border-[#E4E4E7] dark:border-[#374151]">ID Tendik</th> {/* Sesuaikan */}
                ...
                <tbody>
                  {history.map((row, idx) => (
                    <tr key={row.id_presensi || row.id} className="border-b border-[#E4E4E7] dark:border-[#374151]">
                      ...
                      <td className="p-4 text-[#18181B] dark:text-[#F9FAFB] border border-[#E4E4E7] dark:border-[#374151]">{row.id_tendik}</td> {/* Sesuaikan field */}
                      <td className="p-4 text-[#18181B] dark:text-[#F9FAFB] border border-[#E4E4E7] dark:border-[#374151]">{row.nama}</td>
                      <td className="p-4 text-[#18181B] dark:text-[#F9FAFB] border border-[#E4E4E7] dark:border-[#374151]">{new Date(row.waktu).toLocaleDateString('id-ID')}</td> {/* Extract tanggal dari waktu */}
                      <td className="p-4 text-[#18181B] dark:text-[#F9FAFB] border border-[#E4E4E7] dark:border-[#374151]">{new Date(row.waktu).toLocaleTimeString('id-ID')}</td> {/* Extract waktu */}
