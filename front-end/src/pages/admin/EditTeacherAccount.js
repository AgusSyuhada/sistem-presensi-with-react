...
import { useEditTeacherController } from "../../hooks/useEditTeacherController";
        ...
        <div className="font-sans flex flex-col h-screen bg-[#f5f5f5] dark:bg-[#1F2937]">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto bg-[#f5f5f5] dark:bg-[#374151] p-4 md:p-6">
                    ...
                    {isLoading && (
                        <div className="text-center p-6"><span className="text-gray-500 dark:text-gray-400">Loading data guru...</span></div>
                    )}

                    {/* 2. Tampilkan form jika loading selesai dan tidak ada error */}
                    {!isLoading && !error && (
                        <div className="bg-white dark:bg-[#1F2937] p-4 md:p-6 rounded-lg shadow-md">
                            <form onSubmit={handleSubmit}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">

                                    {/* Ganti 'pegid' ke 'id_tendik' dan buat readOnly */}
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1" htmlFor="id_tendik">PEGID (ID Tendik)</label>
                                        <input id="id_tendik" name="id_tendik" type="text" className="w-full px-3 py-2 text-gray-700 dark:text-gray-100 bg-gray-100 dark:bg-[#2d3748] border border-gray-300 dark:border-gray-600 rounded-md" value={form.id_tendik} readOnly />
                                    </div>
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-400 dark:text-gray-500 mb-1" htmlFor="password">Password</label>
                                        <input id="password" name="password" type="password" className="w-full px-3 py-2 text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-[#2d3748] border border-gray-300 dark:border-gray-600 rounded-md" placeholder="Edit password di halaman terpisah" disabled />
                                        <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Perubahan password tidak dilakukan di sini.</p>
                                    </div>
